...
const Dashboard = () => {
  ...
  const user = {
    ...
    avatar: 'https://images.pexels.com/photos/14073969/pexels-photo-14073969.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    badge: 'Pro Blogger',
    streak: 3,
    wordCount: 15230,
  };
  ...
  const blogs = [
    { id: 1, title: 'My First Blog', likes: 30, comments: 4, views: 250, status: 'Published' },
    { id: 2, title: 'Learning React', likes: 12, comments: 2, views: 90, status: 'Draft' },
  ];
  ...
  const avatars = ['https://images.pexels.com/photos/14073969/pexels-photo-14073969.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2', '/avatar2.png', '/avatar3.png'];
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="bg-white p-4 rounded-2xl shadow-md flex gap-4 items-center">
            ...
            <Button className="ml-auto" onClick={() => setEditProfileVisible(true)}>
          ...
          <div className="bg-white p-4 rounded-2xl shadow-md">
            ...
            <ul className="space-y-3">
              {blogs.map((blog) => (
                <li key={blog.id} className="flex items-center justify-between p-3 border rounded-xl">
                  <div>
          ...
          <div className="bg-white p-4 rounded-2xl shadow-md">
            <div className="flex justify-between items-center mb-3">
              ...
              <Button onClick={() => setAvatarModalVisible(true)}>Change Avatar</Button>
            </div>
            <img src={user.avatar} alt="Avatar" className="w-16 h-16 rounded-full" />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
            ...
            <ul className="space-y-3">
              {notifications.map((n) => (
                <li key={n.id} className="text-sm">
                  <span className="font-semibold">{n.user}</span> {n.action} your blog <em>{n.blog}</em>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="bg-white p-4 rounded-2xl shadow-md">
            ...
            <p className="text-sm text-gray-600">List of Daily Tasks completed by you , for those who are having subscription.</p>
      ...
      {/* Modals */}
      <Modal open={avatarModalVisible} onCancel={() => setAvatarModalVisible(false)} footer={null} title="Choose Your Avatar">
        <div className="flex gap-4 flex-wrap justify-center">
          {avatars.map((src, i) => (
            <img
              ...
              src={src}
              alt="avatar"
              className="w-16 h-16 rounded-full cursor-pointer hover:ring-2 ring-blue-500"
      ...
      <Modal open={editProfileVisible} onCancel={() => setEditProfileVisible(false)} title="Edit Profile" footer={null}>
        <p>Profile editing form can be placed here.</p>
      </Modal>
